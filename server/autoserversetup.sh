...
echo
echo " - Building libphidget22 from source. This will take awhile..."
echo
sleep 2
cd /tmp
...
cd /tmp/libphidget22-*
echo
echo " - Setting USB permissions so server can talk with Libphidget boards..."
echo
sleep 2
...
echo
echo
echo " - Done! Please reboot the Raspberry Pi before use!"
